...
export const color = {
	bg: {
		...
		interactive: {
			primary: themeColor.information[400],
			primaryHover: themeColor.information[500],
			secondary: themeColor.neutral[100],
			secondaryHover: themeColor.neutral[50],
			selected: themeColor.brand[50],
			selectedHover: themeColor.brand[200],
			destructive: themeColor.danger[500],
			destructiveHover: themeColor.danger[600],
			inverse: themeColor.base.WHITE,
			inverseStrong: themeColor.base.BLACK,
		},
	},
	border: {
		...
		interactive: {
			primary: themeColor.information[400],
			primaryHover: themeColor.information[700],
			secondary: themeColor.neutral[400],
			secondaryHover: themeColor.neutral[500],
		},
	},
	icon: {
		...
		interactive: {
			primary: themeColor.information[400],
			primaryHover: themeColor.information[600],
			primaryPress: themeColor.information[800],
			secondary: themeColor.neutral[600],
			secondaryHover: themeColor.neutral[700],
			secondaryPress: themeColor.neutral[800],
			selected: themeColor.information[600],
			inverse: themeColor.base.WHITE,
		},
	},
	text: {
		...
		interactive: {
			...
			secondary: themeColor.neutral[600],
			secondaryHover: themeColor.neutral[700],
			selected: themeColor.information[400],
			inverse: themeColor.base.WHITE,
		},
	},
} as const;
